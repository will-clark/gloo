...
// Source: github.com/envoyproxy/go-control-plane/envoy/service/metrics/v3 (interfaces: MetricsService_StreamMetricsServer)
...
import (
	...
	envoy_service_metrics_v3 "github.com/envoyproxy/go-control-plane/envoy/service/metrics/v3"
...
func (m *MockMetricsService_StreamMetricsServer) Recv() (*envoy_service_metrics_v3.StreamMetricsMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*envoy_service_metrics_v3.StreamMetricsMessage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockMetricsService_StreamMetricsServer) SendAndClose(arg0 *envoy_service_metrics_v3.StreamMetricsResponse) error {
	m.ctrl.T.Helper()
