...
func AddRegisterFlags(set *pflag.FlagSet, register *options.Register) {
	...
	set.StringVar(&register.RemoteNamespace, "remote-namespace", "gloo-fed", "namespace in the target cluster where registration artifacts should be written")
...
func AddDeregisterFlags(set *pflag.FlagSet, register *options.Register) {
	...
	set.StringVar(&register.RemoteNamespace, "remote-namespace", "gloo-fed", "namespace in the target cluster where artifacts should be deleted")
}
