...
func AddRegisterFlags(set *pflag.FlagSet, register *options.Register) {
	...
	set.StringVar(&register.FederationNamespace, "federation-namespace", "gloo-fed", "namespace of the Gloo Federation control plane which the cluster will be registered to")
